...
@Component({
  selector: 'app-sales-quotation-approval',
  standalone: true,
  imports: [
    CommonModule, 
    FormsModule, 
  ...
  templateUrl: './sales-quotation-approval.component.html',
  styleUrl: './sales-quotation-approval.component.css'
})
export class SalesQuotationApprovalComponent {
  ...
  handlePendingSearch() {
    console.log('Searching pending quotations...', this.pendingSearchForm());
  }

  handleProcessedSearch() {
    console.log('Searching processed quotations...', this.processedSearchForm());
  }
}
